...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConfirmEmail = findViewById(R.id.confirm_email_address);
        mPassword = findViewById(R.id.password);
        mConfirmPassword = findViewById(R.id.confirm_password);
        mProgressDialog = new ProgressDialog(this);

        ImageView mRegisterButton = findViewById(R.id.register_button);
    ...
    private void registerUser() {
        ...
        if (password.length() < 6) {
            Toast.makeText(Register.this, "Your password must have at least 6 characters", Toast.LENGTH_LONG).show();
            return;
        }
        //checking if email and confirm email match
        if (!email.equals(confirmEmail)) {
            Toast.makeText(Register.this, "Both email address fields must be identical", Toast.LENGTH_LONG).show();
            return;
        }
        //checking if password and confirm password match
        if (!password.equals(passwordConfirm)) {
            Toast.makeText(Register.this, "Both password fields must be identical", Toast.LENGTH_LONG).show();
            return;
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            userListPath.set(new UserListModel(mCurrentUserId));

                            DocumentReference userDetailsPath = mFireBaseFireStore.collection("Users").document(mCurrentUserId).collection("User_Details").document("Sign_Up_Details");
                            userDetailsPath.set(new UserDetailsModel(mCurrentUserEmail, date));
                            ...
                            Intent i = new Intent(Register.this, LocationSetup.class);
            ...
            public void run() {
                try {
                    ...
                    sendSmtpEmail.htmlContent("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\"><head><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\" /><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" /><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><meta name=\"x-apple-disable-message-reformatting\" /><meta name=\"apple-mobile-web-app-capable\" content=\"yes\" /><meta name=\"apple-mobile-web-app-status-bar-style\" content=\"black\" /><meta name=\"format-detection\" content=\"telephone=no\" /><title></title><style type=\"text/css\">\n" +
                            ...
                            "<div>&nbsp;</div>\n" +
                            "\n" +
                            "<div>You can now use your email address and password to log in to the App from any of your devices. Open the App to start reading and sharing weather reports.</div>\n" +
                            "\n" +
                            "<div>&nbsp;</div>\n" +
                            "\n" +
