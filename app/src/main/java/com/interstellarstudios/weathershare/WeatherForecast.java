...
public class WeatherForecast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTimeInterval = bundle.getString("time interval");
        ...
        TextView timeIntervalText = findViewById(R.id.timeIntervalText);
        timeIntervalText.setText(mTimeInterval);
        ...
        toolbarContacts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(WeatherForecast.this, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String permissions[], @NonNull int[] grantResults) {
        ...
        if (requestCode == READ_CONTACTS_PERMISSIONS_REQUEST) {
            if (grantResults.length == 1 &&
                ...
                Toast.makeText(WeatherForecast.this, "Read Contacts permission granted.", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(WeatherForecast.this, "Read Contacts permission denied.", Toast.LENGTH_LONG).show();
            }
        } else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CONTACT_PICKER_RESULT && resultCode == RESULT_OK) {
            ...
            if (email.length() == 0) {
                Toast.makeText(WeatherForecast.this, "No email address stored for this contact.", Toast.LENGTH_LONG).show();
            } else {
    ...
    private void findForecast(String city, final int index) {
        ...
        JsonObjectRequest jor = new JsonObjectRequest(Request.Method.GET, FINAL_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    JSONObject arrayObject = listArray.getJSONObject(index);

                    //main object inside list array
                    JSONObject mainObject = arrayObject.getJSONObject("main");
                    String temp = String.valueOf(mainObject.getInt("temp"));
                    String minTemp = String.valueOf(mainObject.getInt("temp_min"));
                    String maxTemp = String.valueOf(mainObject.getInt("temp_max"));
                    ...
                    JSONArray weatherArray = arrayObject.getJSONArray("weather");
                    JSONObject weatherObject = weatherArray.getJSONObject(0);
                    String description = weatherObject.getString("description");
                    String weatherId = weatherObject.getString("id");
                    int weatherIdInt = Integer.parseInt(weatherId);

                    //wind object inside list array
                    JSONObject windObject = arrayObject.getJSONObject("wind");
                    String windSpeed = String.valueOf(windObject.getInt("speed"));
                    ...
                    String temperatureMinFinalMetric = (minTemp + "°C");
                    String temperatureMinFinalImperial = (minTemp + "°F");
                    String temperatureMaxFinalMetric = (maxTemp + "°C");
                    String temperatureMaxFinalImperial = (maxTemp + "°F");
        ...
        RequestQueue queue = Volley.newRequestQueue(WeatherForecast.this);
        queue.add(jor);
    }
    ...
    private void sendMail() {
        ...
        Toast.makeText(WeatherForecast.this, "Weather forecast report emailed to: " + sharedUserEmail, Toast.LENGTH_SHORT).show();

        Bundle analyticsBundle = new Bundle();
        mFireBaseAnalytics.logEvent("forecast_share_email_called", analyticsBundle);
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    sendSmtpEmail.subject("You've received a weather forecast report from " + mCurrentUserEmail);
                    sendSmtpEmail.setHtmlContent("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\"><head><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\" /><meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" /><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><meta name=\"x-apple-disable-message-reformatting\" /><meta name=\"apple-mobile-web-app-capable\" content=\"yes\" /><meta name=\"apple-mobile-web-app-status-bar-style\" content=\"black\" /><meta name=\"format-detection\" content=\"telephone=no\" /><title></title><style type=\"text/css\">\n" +
                            "        /* Resets */\n" +
                            ...
                            "\n" +
                            "                                                                <tbody><tr>\n" +
                            "                                                                    <td style=\"font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858; line-height: 21px;\"><div><span style=\"font-size:16px;\"><strong>" + mLocation + " - 3 Hour Forecast</strong></span></div>\n" +
                            "\n" +
                            "<div><span style=\"font-size:16px;\"><strong>" + mTimeInterval + "</strong></span></div>\n" +
                            "\n" +
                            "<div><span style=\"font-size:16px;\"><strong>" + description + "</strong></span></div>\n" +
                            "\n" +
                            "<div><br>\n" +
                            "Average Temperature: " + temperature + "</div>\n" +
                            "\n" +
